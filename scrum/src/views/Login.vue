<template>
  <div
    class="min-h-screen flex items-center justify-center bg-[#F0FDF4]"
    
  >
    <span class="absolute top-8 left-1/2 transform -translate-x-1/2 text-5xl font-noto text-white drop-shadow-md">Daily Scrum</span>
    <div
    ...
    >
      ...
      <div class="flex justify-end w-full">
        <router-link to="/forgot-password">
          <button><span class="text-[12px] font-noto">forgot password</span></button>
        </router-link>
      </div>
